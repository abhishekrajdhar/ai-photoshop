...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn("z-50 rounded-md border border-border bg-elevated px-2 py-1 text-[11.5px] text-fg shadow-lg", className)}
      {...props}
    />
  </TooltipPrimitive.Portal>
));
...
/** Convenience wrapper: <Tip label="Split (S)"><Button/></Tip> */
